...
int main(array<System::String ^> ^args)
{
  ...
  {
    Console::WriteLine();
    Console::WriteLine(L"Usage: ServerParMandelbrot.exe x y size pixels instance numInstances");
  ...
  try
  {
    ...
    Console::WriteLine(L"** Server-Side Parallel Mandelbrot [{0} {1}] **", platform, version);
    ...
    rc = mandelbrot->Calculate(x, y, size, pixels, startRowInclusive, endRowExclusive, stepBy, instance);
