...
namespace WCFMandelbrotClient
{
  public class Form1 : System.Windows.Forms.Form
  {
    ...
    private void InitializeComponent()
    {
      ...
      this.Text = "WCF Mandelbrot Client";
  ...
  platform = "32-bit";
      ...
      _versionLabel.Text = String.Format("WCF Mandelbrot Client, {0} {1}", platform, version);
    ...
    private void _goButton_Click(object sender, EventArgs e)
    {
      ...
      if (!_running)  // GO:
      {
        try
        {
          ...
          if (_mandelbrot == null)  // first time through:
    ...
    private void Form1_FormClosed(object sender, FormClosedEventArgs e)
    {
      ...
      {
        _mandelbrot.Close();
        System.Threading.Thread.Sleep(500);  // give service time to shutdown:
      }
    }
