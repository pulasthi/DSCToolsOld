...
namespace ServerParDotNetMandelbrot
{
  ...
  platform = "any-cpu";
      ...
      {
        Console.WriteLine();
        Console.WriteLine("Usage: ServerParMandelbrot.exe x y size pixels instance numInstances");
      ...
      try
      {
        ...
        Console.WriteLine("** Server-Side Parallel Mandelbrot .NET [{0} {1}] **", platform, version);
