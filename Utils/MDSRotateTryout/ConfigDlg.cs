...
namespace MDSTryout
{
    public partial class ConfigDlg : Form
    {
        ...
        private bool _stricMDSAppDirValidation;
        #endregion
        ...
        {
            if ((_type == ConfigDlgType.MDSAppDirectory && Utils.ValidateMDSAppDir(dirTxt.Text, _stricMDSAppDirValidation)) || 
        ...
        public bool StricMDSAppDirValidation { set { _stricMDSAppDirValidation = value; } }
    }
}
