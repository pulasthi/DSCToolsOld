...
namespace WhatsMissing
{
    public static class RangePartitioner
    {
        ...
        public static Range[] Partition(int startIndex, int length, int numPartitions)
        {
            if (numPartitions < 1)
            {
                throw new ArgumentOutOfRangeException("count", "Partitioning requires numPartitions to be greater than zero.");
            }
        ...
        public static Range[] PartitionByLength(int startIndex, int length, int maxPartitionLength)
        {
            ...
            {
                throw new ArgumentException("maxPartitionLength", "Partitioning requires the maxPartitionLength to be greater than zero.");
            }
            if (length < 1)
            {
            ...
            {
                throw new ArgumentException("length", "Partitioning requires the length to be greater than maxPartitionLength.");
            }
