...
namespace AllInOneClusters
{
    public class PlotVizDataFile
    {
        ...
        private static PlotVizDataFile Build(Dictionary<int, string> indexMap, Dictionary<int, ClusterLine> clusterMap, Dictionary<int, PlotVizDataFileCoordinate> coordinatesMap)
        {
            PlotVizDataFile dataFile = new PlotVizDataFile();
