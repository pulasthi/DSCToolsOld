...
//        for (short col = 0; col != numberOfCols; ++col) {
    ...
    protected override void SetColumnBoundaryConditionAffine(short row, int cell) {
    ...
    // Todo: Saliya - optimization test cut offs based on profiling info
     unsafe protected override void FillCellAffine(short row, short col, int cell, sbyte* fSourceElement) {
        int score = SetCellValuesAffine(row, col, cell, fSourceElement);
    ...
    protected override IList<AlignedData> Traceback() {
